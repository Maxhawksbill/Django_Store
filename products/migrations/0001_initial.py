# Generated by Django 5.0.1 on 2024-02-25 20:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.FloatField(default=1)),
                ('inventory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.product')),
        ...
        migrations.AddField(
            model_name='store',
            name='inventory',
            field=models.ManyToManyField(related_name='stores', through='products.StoreInventory', to='products.product'),
        ),
    ]
